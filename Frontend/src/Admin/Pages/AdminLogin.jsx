                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={formData.email}
                                onChange={handleChange}
                                className={`w-full mt-1 px-4 py-3 rounded-lg border ${errors.email
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    value={formData.password}
                                    onChange={handleChange}
                                    className={`w-full mt-1 px-4 py-3 rounded-lg border ${errors.password
                                        ? "border-red-500"
                                        : "border-gray-300"
                                        } focus:outline-none focus:ring-2 focus:ring-green-500`}
                                />
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 mt-0.5 text-gray-500 hover:text-green-600"
                                >
                                    {showPassword ? (
                                        <FaEyeSlash size={20} />
                                    ) : (
                ...
                <div className="hidden md:flex w-1/2 bg-gradient-to-br from-green-600 to-lime-700 items-center justify-center text-white p-12">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base opacity-90 leading-relaxed max-w-xs mx-auto">
                            ...
                            and track your sports gear orders.
                        </p>
