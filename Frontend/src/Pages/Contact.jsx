...
// //             <p>
// //               📍 <span className="font-semibold">Address:</span> Main Road,
// //               Bannu, KPK
// //             </p>
...
// //             <p>
// //               ⏰ <span className="font-semibold">Timing:</span> 9:00 AM – 5:00
// //               PM
// //             </p>
// //           </div>
// //         </div>
...
// //           className="bg-[#242424] p-8 rounded-xl shadow-lg"
// //         >
// //           <h2 className="text-2xl font-semibold mb-6">
// //             Send Us a Message
// //           </h2>
...
// import React, { useState } from "react";
// import axios from "axios";
// import Navber from "../components/Navber"; // Fixed typo 'Navber' to 'Navbar'
...
//           <div className="space-y-4 text-gray-300">
//             <p>
//               📍 <span className="font-semibold">Address:</span> Main Road, Bannu, KPK
//             </p>
//             <p>
//               📞 <span className="font-semibold">Phone:</span> +92 300 1234567
//             </p>
//             <p>
//               ✉️ <span className="font-semibold">Email:</span> famoussports@gmail.com
//             </p>
//             <p>
//               ⏰ <span className="font-semibold">Timing:</span> 9:00 AM – 5:00 PM
//             </p>
//           </div>
//         </div>

//         {/* Contact Form */}
//         <form onSubmit={handleSubmit} className="bg-[#242424] p-8 rounded-xl shadow-lg">
    ...
    <div className="min-h-screen bg-black text-white px-6 py-12">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="bg-[#242424] p-8 rounded-xl shadow-lg">
          ...
          <div className="space-y-4 text-gray-300">
            <p>📍 <span className="font-semibold">Address:</span> Main Road, Bannu, KPK</p>
