      ...
      <div className='w-full h-[600px] bg-black text-white overflow-hidden'>
        ...
        <main className='relative max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center'>
          ...
          >
            ...
            <p className='mt-0 text-gray-400 max-w-md text-lg'>
            ...
            {categoryList.length > 0 ? (
              categoryList.map((item) => (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  className="bg-[#1e1e1e] min-w-[320px] p-4 rounded-xl border border-transparent hover:border-yellow-400/50 transition-colors duration-300 shadow-xl"
                >
                  ...
                  onClick={(e)=> navigate("/shop")}
                    whileTap={{ scale: 0.9 }}
                    className="mt-6 w-full py-3 bg-yellow-400 text-black font-bold rounded-2xl hover:bg-yellow-500 transition-colors"
                  >
                    View Products
                  </motion.button>
                </motion.div>
              ...
              <p className="text-gray-500 w-full text-center py-10">No categories found</p>
            )}
          </motion.div>
        </div>
      </div>
          ...
          <motion.div
            variants={{
              ...
              visible: {
                ...
                transition: {
                  duration: 0.8,
                  staggerChildren: 0.2, // Animate h1, then p, then buttons
                  delayChildren: 0.3
                }
              }
            }}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <p>Main Bazar Bannu, near Chowk Market, <br />Khyber Pakhtunkhwa - Pakistan</p>
            </div>
            ...
            <div className="space-y-1">
              <p className="text-xs text-gray-500 font-bold">For International Queries:</p>
              <div className="flex items-center gap-3 text-sm text-gray-400">
